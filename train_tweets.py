...
# df = df[~df.category.str.contains('\|')]  # only want for multi-emotion
...
#     torch.load('finetuned_bert_epoch_1_gpu_trained.model', map_location=torch.device('cpu')), strict=False)
